...
def test_import_script_analyse_mission() -> None:
    ...
    # arrange
    # act
    from src import analyse_mission  # noqa: PLC0415 import-outside-top-level
...
def test_import_script_analyse_missions() -> None:
    ...
    # arrange
    # act
    from src import analyse_missions  # noqa: PLC0415 import-outside-top-level
...
def test_import_script_build_docs() -> None:
    ...
    # arrange
    # act
    from src import build_docs  # noqa: PLC0415 import-outside-top-level
