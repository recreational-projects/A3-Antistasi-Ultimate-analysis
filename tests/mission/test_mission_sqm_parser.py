...
def test_get_entities(parsed_root_fragment: Node) -> None:
...
def test_get_marker_nodes(parsed_root_fragment: Node) -> None:
...
def test_get_layer_nodes(parsed_root_fragment: Node) -> None:
    """Test that markers are derived from a given node."""
    # arrange
    # act
